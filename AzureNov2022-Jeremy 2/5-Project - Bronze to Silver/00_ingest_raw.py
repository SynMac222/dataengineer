...
# TODO
print(dbutils.fs.head(dbutils.fs.ls("dbfs:/dbacademy/dbacademy/dataengineering/classic/raw/")[0].path))

# COMMAND ----------

# TODO
print(dbutils.fs.head(dbutils.fs.ls("dbfs:/dbacademy/dbacademy/dataengineering/classic/raw/")[1].path))
